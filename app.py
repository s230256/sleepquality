...
b = st.number_input(' 평균 수면 시간 입력 ', value=0 )     # 초기값은 0.0
c = st.number_input(' 평균 공부 시간 입력 ', value=0 )     # 초기값은 0.0
d = st.number_input(' 전자기기 사용시간 입력 ', value=0)      #초기값은 0
e = st.number_input(' 카페인 섭취량 입력 (@잔) ', value=0 )     # 초기값은 0.0
f = st.number_input(' 신체 활동시간 입력 (분) ', value=0 )     # 초기값은 0.0
